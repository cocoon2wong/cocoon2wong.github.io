---
title: Conghao Wong
coverImg: /assets/img/team/conghaowongback.JPG
customCss:
...
import SecondNavTitle from "../../components/SecondNavTitle.astro";
...
>
  <Fragment slot="secondNav">
    <SecondNavBreadcrumb showCurrentPage={false} />
    <SecondNavTitle title="Conghao Wong" />
    <SecondNavSpacer />
  </Fragment>
  ...
  <div class="team-profile-info">
    ...
    <Pill
      ...
      items={[
        ...
        { label: "Google Scholar", href: "https://scholar.google.com/citations?user=cA_6-EwAAAAJ" },
        { label: "Home page", href: "https://conghaowong.com" },
      ]}
    />
  </div>
...
- Conference on Neural Information Processing Systems (NeurIPS) 2025, 2026, 🏆 NeurIPS 2025 "Reviewer : Top Reviewer";
